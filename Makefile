# This Makefile is for the MooseX::Async extension to perl.
#
...
#     ABSTRACT => q[The Orphanange of Asynchronous Love Children]
#     AUTHOR => q[Chris Prather  C<< <perigrin@cpan.org> >>]
#     DIR => []
#     DISTNAME => q[MooseX-Async]
#     NAME => q[MooseX::Async]
#     NO_META => q[1]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0.42], MooseX::AttributeHelpers=>q[0.09], Moose=>q[0.26] }
#     VERSION => q[0.05]
#     dist => { PREOP=>q[$(PERL) -I. "-MModule::Install::Admin" -e "dist_preop(q($(DISTVNAME)))"] }
#     test => { TESTS=>q[t/01_use.t] }
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/MooseX/Async.pm \
	lib/MooseX/Async/Meta/Class.pm \
	lib/MooseX/Async/Meta/Method/State.pm
...
TO_INST_PM = lib/MooseX/Async.pm \
	lib/MooseX/Async/Meta/Class.pm \
	lib/MooseX/Async/Meta/Method/State.pm \
	lib/MooseX/Async/Meta/Role.pm

PM_TO_BLIB = lib/MooseX/Async/Meta/Method/State.pm \
	blib/lib/MooseX/Async/Meta/Method/State.pm \
	lib/MooseX/Async/Meta/Class.pm \
	blib/lib/MooseX/Async/Meta/Class.pm \
	lib/MooseX/Async.pm \
	blib/lib/MooseX/Async.pm \
	lib/MooseX/Async/Meta/Role.pm \
	blib/lib/MooseX/Async/Meta/Role.pm
...
DISTNAME = MooseX-Async
DISTVNAME = MooseX-Async-0.05
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/MooseX/Async/Meta/Method/State.pm $(INST_MAN3DIR)/MooseX::Async::Meta::Method::State.$(MAN3EXT) \
	  lib/MooseX/Async/Meta/Class.pm $(INST_MAN3DIR)/MooseX::Async::Meta::Class.$(MAN3EXT) \
	  lib/MooseX/Async.pm $(INST_MAN3DIR)/MooseX::Async.$(MAN3EXT) 
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>The Orphanange of Asynchronous Love Children</ABSTRACT>' >> $(DISTNAME).ppd
	...
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="MooseX-AttributeHelpers" VERSION="0,09,0,0" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' -- \
	  lib/MooseX/Async/Meta/Method/State.pm blib/lib/MooseX/Async/Meta/Method/State.pm \
	  lib/MooseX/Async/Meta/Class.pm blib/lib/MooseX/Async/Meta/Class.pm \
	  lib/MooseX/Async.pm blib/lib/MooseX/Async.pm \
	  lib/MooseX/Async/Meta/Role.pm blib/lib/MooseX/Async/Meta/Role.pm 
